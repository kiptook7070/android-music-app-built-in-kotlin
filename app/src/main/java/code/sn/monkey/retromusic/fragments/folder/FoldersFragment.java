...
package code.sn.monkey.retromusic.fragments.folder;
...
import code.sn.monkey.retromusic.adapter.SongFileAdapter;
...
import code.sn.monkey.retromusic.helper.menu.SongMenuHelper;
import code.sn.monkey.retromusic.helper.menu.SongsMenuHelper;
import code.sn.monkey.retromusic.interfaces.ICabHolder;
import code.sn.monkey.retromusic.interfaces.ICallbacks;
import code.sn.monkey.retromusic.interfaces.IMainActivityFragmentCallbacks;
import code.sn.monkey.retromusic.misc.DialogAsyncTask;
import code.sn.monkey.retromusic.misc.UpdateToastMediaScannerCompletionListener;
import code.sn.monkey.retromusic.misc.WrappedAsyncTaskLoader;
import code.sn.monkey.retromusic.model.Song;
import code.sn.monkey.retromusic.util.DensityUtil;
import code.sn.monkey.retromusic.util.FileUtil;
import code.sn.monkey.retromusic.util.PreferenceUtil;
import code.sn.monkey.retromusic.util.RetroColorUtil;
import code.sn.monkey.retromusic.util.ThemedFastScroller;
import code.sn.monkey.retromusic.views.BreadCrumbLayout;
import code.sn.monkey.retromusic.views.ScrollingViewOnApplyWindowInsetsListener;
import me.zhanghai.android.fastscroll.FastScroller;

import static code.sn.monkey.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor;
